...
class _EventMapState extends State<EventMap> with TickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    ...
    //geocode(widget.loc!);
    result = LatLng(double.parse(widget.loc!.split(',')[0]), double.parse(widget.loc!.split(',')[1]));
    //print(result);
  ...
  void geocode(address) async{
    ...
    //print('location: ' + locations[0].toString());
    //result.add(LatLng(locations[0].latitude, locations[0].longitude));
    setState(() {
